def is_valid_word(wordlist, word):
    ...
    True
    >>> is_valid_word(['ANT', 'BOX', 'SOB', 'TO'], 'TXXO')
    False
    """
...
def make_str_from_row(board, row_index):
    ...
    completedString = ""
    for letters in board[row_index]:
        completedString = completedString + letters
...
def make_str_from_column(board, column_index):
    ...
    for eachrow in board:
        completedString = completedString + eachrow[column_index]
    return completedString
...
def word_score(word):
    ...
    if wordlength < 3:
        return 0
    elif wordlength >= 3 and wordlength <=6:
        return 1*wordlength
    elif wordlength >= 7 and wordlength <=9:
        return 2*wordlength
    elif wordlength >= 10:
        return 3*wordlength
    else:
